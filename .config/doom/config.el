...
(setq user-full-name "Arialdo Martini"
      user-mail-address "arialdo.martini@gmail.com")
...
(global-set-key (kbd "s-l i") 'windmove-up)
(global-set-key (kbd "s-l l") 'windmove-right)
(global-set-key (kbd "s-l j") 'windmove-left)
(global-set-key (kbd "s-l k") 'windmove-down)
